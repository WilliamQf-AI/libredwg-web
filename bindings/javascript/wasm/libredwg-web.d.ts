...
interface EmbindModule {
  ...
  dwg_set_version_type(_0: number, _1: number): void;
  ...
  dwg_write_file(_0: EmbindString, _1: number): number;
  ...
  dxf_write_file(_0: EmbindString, _1: number): number;
  dxf_write_binary(_0: EmbindString, _1: number): number;
